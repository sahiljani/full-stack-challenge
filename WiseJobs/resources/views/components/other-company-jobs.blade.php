<div class="bg-white dark:bg-gray-800 p-6 md:p-10 rounded-lg shadow-lg">
    <h4 class="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-gray-200 mb-4">
        Other Jobs at {{ $jobPosting->company->name }}
    </h4>

    @if($companyJobs->isEmpty())
        <p class="text-lg md:text-xl text-gray-600 dark:text-gray-400">
            No other jobs available at this company.
        </p>
    @else
